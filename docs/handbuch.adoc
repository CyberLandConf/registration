...
Links steht eine Leiste mit Logo und Namen der JUG und fünf Einträgen:
...
* *Neue JUG* – eine weitere JUG anlegen (nur mit der zusätzlichen Rolle `admin`)
...
Diese Seite legt eine weitere JUG in der Anwendung an. Sie ist den Betreibern vorbehalten und
erfordert zusätzlich zur Mandantenrolle die Rolle `admin`; für die Orga-Teams der einzelnen
JUGs ist sie gesperrt.
...
Alles Übrige – Website, Datenschutz- und Impressum-URL, Logo, Reply-To, Events-URL sowie
sämtliche Hilfetexte – wird von der Vorlage-JUG `test` kopiert. Die neue JUG ist damit sofort
